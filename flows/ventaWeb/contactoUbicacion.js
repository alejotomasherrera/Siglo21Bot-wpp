...
module.exports = {
  contactoUbicacion: (chatgptClass) => {
    return addKeyword("contacto", {
      ...
      .addAnswer(
        `¿Necesitas más información o tienes alguna pregunta sobre el contacto y la ubicación? Si deseas volver al menu ingresa: venta web`,
        { capture: true },
        async (ctx, { fallBack }) => {
