...
module.exports = {
  contacto: (chatgptClass) => {
    return addKeyword(["contacto","Contacto","CONTACTO"], {
      sensitive: true,
      ...
      .addAnswer(
        `¿Necesitas más información o tienes alguna pregunta sobre el contacto? Si deseas volver al menu ingresa: venta web`,
        { capture: true },
        async (ctx, { fallBack }) => {
